...
class TownDatabase:
    ...
    client = pymongo.MongoClient(uri, tls=True, tlsCertificateKeyFile='D:\Programowanie\Python Projects\DiscordSecretaryNew\certs_and_tokens/X509-cert-7952542027018750515.pem')
